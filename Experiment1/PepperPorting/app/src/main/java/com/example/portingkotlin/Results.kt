    ...
    companion object {
        ...
        fun saveResults(qi: QiContext) {
            ...
            // Dati da scrivere nel file CSV
                ...
                "Strategia 1 per la dimensione (2 immagini): Nessuna modifica",
                "Strategia 1 per la dimensione (4 immagini): Nessuna modifica",
                "Strategia 2 per la dimensione (2 immagini): Cambia in base ai modificatori",
                "Strategia 2 per la dimensione (4 immagini): Cambia in base ai modificatori",
                "Quale strategia per la dimensione hai preferito?",
                "Quale strategia per la quantità di immagini hai preferito?",
                "Strategia 1 per le immagini: Le immagini appaiono dopo il completamento della frase",
                "Strategia 2 per le immagini: Le immagini appaiono simultaneamente alle parole",
                "Strategia 3 per le immagini: L'apparizione dipende dell'albero a dipendenze",
